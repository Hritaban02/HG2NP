...
class DiscreteDenoisingDiffusion(pl.LightningModule):
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        if wandb.run:
            wandb.log({"val/epoch": self.current_epoch, # Added current epoch number
    ...
    def on_test_epoch_end(self) -> None:
        ...
        if wandb.run:
            wandb.log({"test/epoch": self.current_epoch, # Added current epoch number
        ...
        if wandb.run:
            wandb.log({"test/epoch": self.current_epoch, # Added current epoch number
                       "test/epoch_NLL": test_nll}, commit=False)
    ...
    def compute_val_loss(self, pred, noisy_data, X, E, y, node_mask, test=False):
       ...
       """
        ...
        if wandb.run:
            wandb.log({"val_counter": self.val_counter, # Added val_counter
