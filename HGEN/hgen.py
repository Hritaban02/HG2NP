...
parser.add_argument("--dataset", choices=["syn_100", "syn_200", "syn_500", "PubMed", "IMDB_movie", "DBLP_four_area", "IMDB_year"], 
...
# meta_path_length_2, meta_path_length_3, meta_path_length_4 = getting_metapaths(_A_obs)
# pickle.dump(meta_path_length_2, open(args.dataset+"/path_len_2.p", "wb"))
# pickle.dump(meta_path_length_3, open(args.dataset+"/path_len_3.p", "wb"))
# pickle.dump(meta_path_length_4, open(args.dataset+"/path_len_4.p", "wb"))
